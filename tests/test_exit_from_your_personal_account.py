...
class TestExitFromYourPersonalAccount:
    def test_exit_from_your_personal_account(self, driver):
        ...
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, StellarLocators.INPUT_MAIN)))
        driver.find_element(By.LINK_TEXT, StellarLocators.PA_BUTTON).click()
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, StellarLocators.ACCOUNT_LOGIN)))
        driver.find_element(By.XPATH, StellarLocators.OUT).click()
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, StellarLocators.AUTH_LOGIN)))
