...
class StellarLocators:
    ...
    FILLINGS = (By.XPATH, "//span[text() = 'Начинки']/parent::div")  # Переход к разделу Начинки
    SAUCES = (By.XPATH, "//span[text() = 'Соусы']/parent::div")  # Переход к разделу Соусы
    ROLLS = (By.XPATH, "//span[text() = 'Булки']/parent::div")  # Переход к разделу Булки
